...
class UpdatesControllerTest < ActionController::TestCase
  ...
  test "should create update" do
    assert_difference('Update.count') do
      post :create, update: { pains: @update.pains, plans: @update.plans, progress: @update.progress, project_id: @update.project_id, user_id: @update.user_id }
    end
  ...
  test "should update update" do
    patch :update, id: @update, update: { pains: @update.pains, plans: @update.plans, progress: @update.progress, project_id: @update.project_id, user_id: @update.user_id }
    assert_redirected_to update_path(assigns(:update))
  end
